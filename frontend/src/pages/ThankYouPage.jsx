...
const ThankYouPage = () => {
  ...
  const { product, variant, quantity, orderSummary, customerInfo } = cart;
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="border-b border-gray-200 mb-6 pb-6">
            ...
            <p className="text-gray-700 mb-4">
              <span className="font-medium">Order Date:</span> {new Date(timestamp).toLocaleString()}
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div>
              ...
              <p className="text-gray-700">{customerInfo.city}, {customerInfo.state} {customerInfo.zipCode}</p>
